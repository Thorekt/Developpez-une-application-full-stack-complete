...
public class UserControllerTest {
    ...
    public void findById_shouldReturnValidUserResponse_whenUserExists() {
        ...
        // When
        ResponseEntity<ApiResponse> response = classUnderTest.findById(uuidString);

        // Then
        assertEquals(uuid, ((UserDto) response.getBody()).getId());
    ...
    public void findById_shouldReturnBadRequestResponse_whenInvalidUuidFormatIsProvided() {
        ...
        // When
        ResponseEntity<ApiResponse> response = classUnderTest.findById(invalidUuidString);
